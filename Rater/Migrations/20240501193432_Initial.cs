        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeanValueSum = table.Column<double>(type: "float", nullable: false),
                    ValuesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MeanValuesJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnersName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
